...
export const CloudIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 15a4 4 0 011-7.87 4 4 0 017.135-1.798 6 6 0 0111.723 3.745 4.49 4.49 0 01-1.79 8.922H4a4.002 4.002 0 01-1-8z" />
  </svg>
);
